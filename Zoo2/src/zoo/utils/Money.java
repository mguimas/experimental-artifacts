...
public final class Money implements Comparable<Money>, Serializable {
	 ...
	 * constructor.
	 */
	private static Currency DEFAULT_CURRENCY = Currency.getInstance(Locale.getDefault());

	/**
	 * The default rounding style to be used if no currency is passed to the
	 * constructor. See {@link BigDecimal}.
	 */
	private static RoundingMode DEFAULT_ROUNDING = RoundingMode.HALF_UP;
	...
	public int getNumDecimalsForCurrency() {
